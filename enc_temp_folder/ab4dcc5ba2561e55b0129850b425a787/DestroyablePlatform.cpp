...
void ADestroyablePlatform::BeginPlay()
{
	...
	RangeFunctionMap.Add(2, [this]() { OnChangeHighZone(); });
	RangeFunctionMap.Add(3, [this]() { OnChangeHighZone(); });
	RangeFunctionMap.Add(4, [this]() { OnChangeMediumZone(); });
	RangeFunctionMap.Add(5, [this]() { OnChangeMediumZone(); });
	RangeFunctionMap.Add(6, [this]() { OnChangeMediumZone(); });
